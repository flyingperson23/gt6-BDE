...
public class Loader_PrefixBlocks implements Runnable {
	...
	public void run() {
		...
		if (DISABLE_MACHINES) {
			((PrefixBlock_) BlocksGT.blockPlate).setHidden(true);
			((PrefixBlock_) BlocksGT.blockPlateGem).setHidden(true);
			((PrefixBlock_) BlocksGT.casingMachine).setHidden(true);
			((PrefixBlock_) BlocksGT.casingMachineDouble).setHidden(true);
			((PrefixBlock_) BlocksGT.casingMachineQuadruple).setHidden(true);
			((PrefixBlock_) BlocksGT.casingMachineDense).setHidden(true);
			((PrefixBlock_) BlocksGT.blockIngot).setHidden(true);
			((PrefixBlock_) BlocksGT.blockDust).setHidden(true);
		}
