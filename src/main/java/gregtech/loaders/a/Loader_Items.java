...
public class Loader_Items implements Runnable {
	...
	public void run() {
		...
		if (!DISABLE_BEES) ItemsGT.BUMBLEBEES = new MultiItemBumbles();
		...
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.dustDiv72"                   , OP.dustDiv72                      );
		...
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.crushedTiny"                 , OP.crushedTiny                    );
		new PrefixItem(MD.GT, "gt.meta.crushedPurified"             , OP.crushedPurified                );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.crushedPurifiedTiny"         , OP.crushedPurifiedTiny            );
		new PrefixItem(MD.GT, "gt.meta.crushedCentrifuged"          , OP.crushedCentrifuged             );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.crushedCentrifugedTiny"      , OP.crushedCentrifugedTiny         );
		...
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.gemLegendary"                , OP.gemLegendary                   );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.boule"                       , OP.bouleGt                        );
		
		new PrefixItem(MD.GT, "gt.meta.nugget"                      , OP.nugget                         );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.chunkGt"                     , OP.chunkGt                        );
		...
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.plateGemTiny"                , OP.plateGemTiny                   );
		new PrefixItem(MD.GT, "gt.meta.plateGem"                    , OP.plateGem                       );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.plateTiny"                   , OP.plateTiny                      );
		...
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.scrapGt"                     , OP.scrapGt                        );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.rockGt"                      , OP.rockGt                         );

		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.gearGtSmall"                 , OP.gearGtSmall                    );
		new PrefixItem(MD.GT, "gt.meta.gearGt"                      , OP.gearGt                         );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.rotor"                       , OP.rotor                          );
		new PrefixItem(MD.GT, "gt.meta.stick"                       , OP.stick                          );
		new PrefixItem(MD.GT, "gt.meta.stickLong"                   , OP.stickLong                      );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.springSmall"                 , OP.springSmall                    );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.spring"                      , OP.spring                         );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.lens"                        , OP.lens                           );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.round"                       , OP.round                          );
		...
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.chain"                       , OP.chain                          );
		new PrefixItem(MD.GT, "gt.meta.foil"                        , OP.foil                           );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.casingSmall"                 , OP.casingSmall                    );
		new PrefixItem(MD.GT, "gt.meta.wireFine"                    , OP.wireFine                       );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.minecartWheels"              , OP.minecartWheels                 );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.railGt"                      , OP.railGt                         );
		...
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawSword"            , OP.toolHeadRawSword               );
		new PrefixItem(MD.GT, "gt.meta.toolHeadSword"               , OP.toolHeadSword                  );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawPickaxe"          , OP.toolHeadRawPickaxe             );
		new PrefixItem(MD.GT, "gt.meta.toolHeadPickaxe"             , OP.toolHeadPickaxe                );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadPickaxeGem"          , OP.toolHeadPickaxeGem             );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadConstructionPickaxe" , OP.toolHeadConstructionPickaxe    );
		new PrefixItem(MD.GT, "gt.meta.toolHeadBuilderwand"         , OP.toolHeadBuilderwand            );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawShovel"           , OP.toolHeadRawShovel              );
		new PrefixItem(MD.GT, "gt.meta.toolHeadShovel"              , OP.toolHeadShovel                 );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawSpade"            , OP.toolHeadRawSpade               );
		new PrefixItem(MD.GT, "gt.meta.toolHeadSpade"               , OP.toolHeadSpade                  );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawAxe"              , OP.toolHeadRawAxe                 );
		new PrefixItem(MD.GT, "gt.meta.toolHeadAxe"                 , OP.toolHeadAxe                    );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawAxeDouble"        , OP.toolHeadRawAxeDouble           );
		new PrefixItem(MD.GT, "gt.meta.toolHeadAxeDouble"           , OP.toolHeadAxeDouble              );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawHoe"              , OP.toolHeadRawHoe                 );
		...
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawChisel"           , OP.toolHeadRawChisel              );
		new PrefixItem(MD.GT, "gt.meta.toolHeadChisel"              , OP.toolHeadChisel                 );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawSaw"              , OP.toolHeadRawSaw                 );
		...
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawUniversalSpade"   , OP.toolHeadRawUniversalSpade      );
		new PrefixItem(MD.GT, "gt.meta.toolHeadUniversalSpade"      , OP.toolHeadUniversalSpade         );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawSense"            , OP.toolHeadRawSense               );
		new PrefixItem(MD.GT, "gt.meta.toolHeadSense"               , OP.toolHeadSense                  );
		if (!DISABLE_NEISPAM) new PrefixItem(MD.GT, "gt.meta.toolHeadRawPlow"             , OP.toolHeadRawPlow                );
		...
		/*
		MAIN = new CreativeTab("main", "GregTech: Main", MultiItemRandomTools.getItemById(9001), (short) 0);
		MATERIALS = new CreativeTab("materials", "GregTech: Materials", OP.ingot.mat(MT.Steel, 1).getItem(), (short) 0);

		for (OreDictPrefix p : new OreDictPrefix[]{dust, dustSmall, dustTiny, dustImpure, dustPure, crushed, crushedPurified, dustRefined, gemChipped, gemFlawed,
				gem, gemFlawless, gemExquisite, nugget, ingot, ingotDouble, ingotTriple, ingotQuadruple, ingotQuintuple, plateGem, plate, plateDouble, plateTriple,
				plateQuadruple, plateQuintuple, plateDense, plateCurved, gearGt, stick, stickLong, bolt, screw, ring, foil, wireFine, chemtube, toolHeadSword,
				toolHeadPickaxe, toolHeadConstructionPickaxe, toolHeadBuilderwand, toolHeadShovel, toolHeadSpade, toolHeadAxe, toolHeadAxeDouble, toolHeadHoe,
				toolHeadHammer, toolHeadFile, toolHeadChisel, toolHeadSaw, toolHeadDrill, toolHeadChainsaw, toolHeadWrench, toolHeadScrewdriver, toolHeadUniversalSpade,
				toolHeadSense, toolHeadPlow, toolHeadBuzzSaw, blockGem, blockSolid, ore}) {
			p.mCreativeTab = MATERIALS;
		}*/
	}
}
